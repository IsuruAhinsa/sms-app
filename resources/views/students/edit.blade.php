                        ...
                        <div class="mt-6 gap-x-4 gap-y-6 grid grid-cols-1 sm:grid-cols-6">
                            <div class="sm:col-span-3">
                                ...
                                <select id="guardian" name="guardian"
                                    ...
                                    <option disabled>Please select the parent</option>
                                    @forelse($guardians as $guardian)
                                        <option value="{{ $guardian->id }}" @selected($guardian->id == $student->guardian_id)>
                                            {{ $guardian->name }} -
                            ...
                            <div class="sm:col-span-3">
                                ...
                                <x-text-input id="middle_name" name="middle_name" type="text"
                                    class="mt-1 block w-full" :value="$student->middle_name" required />
                            ...
                            <div class="sm:col-span-3">
                                ...
                                <div class="mt-1 flex items-center">
                                    ...
                                    <img class="inline-block h-12 w-12 rounded-full"
                                        src="{{ asset('/img/students/' . $student->image) }}" alt="">
                                    <div class="ml-4 flex">
                                        <div
